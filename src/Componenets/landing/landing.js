        ...
        <div className="landing" id="landing-section">
         ...
         <div className="popUp">
            ...
            <p className="popUpTxt">
               Hei, jos eksyit tälle sivulle huomautan että sivut
               ovat vielä valmistuksessa ja ne eivät toimi tai näytä täysin oikealta.
               Sivut valmistuvat piakkoin.
            </p>
            <button onClick={handleClosePopUp} className="popUpBtn">Sulje ikkuna</button>
         </div>
         )}
